...
public class DashboardPage extends javax.swing.JFrame {
    ...
    public DashboardPage() {
        ...
        gridLayout.add(new GridBox("src/Images/doctor.png", "Medical Staff"));
        gridLayout.add(new GridBox("src/Images/patient.png", "Students"));
        gridLayout.add(new GridBox("src/Images/appointment.png", "Appointment"));
        gridLayout.add(new GridBox("src/Images/medicine.png", "Reports"));
